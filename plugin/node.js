  ...
  var defs = {
    ...
    "!define": {
      ...
      assert: {
        ...
        ok: {
          ...
          "!doc": "Tests if value is truthy. It is equivalent to assert.equal(true, !!value, message)."
        },
        equal: {
        ...
        deepEqual: {
          ...
          "!doc": "Tests for deep equality. Primitive values are compared with the equal comparison operator ( == ). Doesn't take object prototypes into account."
        },
        notDeepEqual: {
        ...
        deepStrictEqual: {
          ...
          "!doc": "Tests for deep equality. Primitive values are compared with the strict equality operator ( === )."
        },
        notDeepStrictEqual: {
          "!type": "fn(actual: ?, expected: ?, message?: string)",
          "!url": "https://nodejs.org/api/assert.html#assert_assert_notdeepstrictequal_actual_expected_message",
          "!doc": "Tests for deep inequality. Opposite of assert.deepStrictEqual."
        },
        "throws": {
          "!type": "fn(block: fn(), error?: ?, messsage?: string)",
          "!url": "https://nodejs.org/api/assert.html#assert_assert_throws_block_error_message",
          "!doc": "Expects block to throw an error. error can be a constructor, RegExp, or validation function."
        },
        doesNotThrow: {
          "!type": "fn(block: fn(), error?: ?, messsage?: string)",
          "!url": "https://nodejs.org/api/assert.html#assert_assert_doesnotthrow_block_message",
          "!doc": "Expects block not to throw an error. See assert.throws() for details."
        },
        ifError: {
          "!type": "fn(value: ?)",
    ...
    Buffer: {
      ...
      prototype: {
        ...
        writeUIntLE: "fn(value: number, offset: number, byteLength: number, noAssert?: bool) -> number",
        writeUIntBE: "fn(value: number, offset: number, byteLength: number, noAssert?: bool) -> number",
        writeIntLE: "fn(value: number, offset: number, byteLength: number, noAssert?: bool) -> number",
        writeIntBE: "fn(value: number, offset: number, byteLength: number, noAssert?: bool) -> number",
        readUIntLE: "fn(offset: number, byteLength: number, noAssert?: bool) -> number",
        readUIntBE: "fn(offset: number, byteLength: number, noAssert?: bool) -> number",
        readIntLE: "fn(offset: number, byteLength: number, noAssert?: bool) -> number",
        readIntBE: "fn(offset: number, byteLength: number, noAssert?: bool) -> number",
        toString: "fn(encoding?: string, start?: number, end?: number) -> string",
        toJSON: "fn() -> ?",
        equals: "fn(otherBuffer: +Buffer) -> bool",
        compare: "fn(otherBuffer: +Buffer) -> number",
        ...
        indexOf: "fn(value: ?, byteOffset?: number) -> number",
